...
<article
	class="p-6 bg-gray-900 rounded-lg border border-gray-700 shadow-md text-start supportshover:opacity-40 supportshover:hover:opacity-100 supportshover:hover:border-cyan-400 motion-safe:transition-colors motion-safe:transition-opacity motion-safe:duration-300 motion-safe:ease-in-out"
>
